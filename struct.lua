...
-- ex:
-- local example = struct.struct {
--   struct.uint16("field_1"),
--   struct.string[8]("field_2")
-- }
...
setmetatable(lib, gmt)
setmetatable(types.string, smt)

-- step 4: ???

-- step 5: profit

function lib.struct(fields, name)
  if checkArg then checkArg(1, fields, "table") end
  if checkArg then checkArg(2, name, "string", "nil") end
